...
def test_evaluate_end_to_end_success():
    ...
    from qiskit_migration.migration.models import MigrationResult, SandboxReport, ValidationReport
...
def test_evaluate_end_to_end_unapplied_change():
    from qiskit_migration.eval.metrics import evaluate_end_to_end
    from qiskit_migration.migration.models import MigrationResult, ValidationReport
